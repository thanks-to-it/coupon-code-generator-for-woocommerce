<?php
/**
 * Coupon Code Generator for WooCommerce - Core Class
 *
 * @version 2.0.0
 * @since   1.0.0
 *
		...
		if (
			...
			$coupon = array(
				...
				'post_excerpt' => sprintf(
					...
					__( 'Created by "%1$s" plugin for order #%2$s', 'coupon-code-generator-for-woocommerce' ),
					__( 'Coupon Code Generator for WooCommerce', 'coupon-code-generator-for-woocommerce' ),
					$order->get_id()
				),
			);
			...
			if ( $coupon_id ) {
				...
				$order->add_order_note(
					sprintf(
						...
						__( '"%1$s" plugin generated <code>%2$s</code> coupon for this order.', 'coupon-code-generator-for-woocommerce' ),
						__( 'Coupon Code Generator for WooCommerce', 'coupon-code-generator-for-woocommerce' ),
						$code
					)
				);
